...
const Contact = ({
  ...
  <div className="contact-wrapper neeto-ui-rounded-sm neeto-ui-border-gray-300 neeto-ui-shadow-xs m-4 grid flex-1 divide-y border p-4 hover:scale-150">
    <div className="contact-container mb-4">
      <div className="contact-title flex justify-between">
    ...
    <div className="contact-footer grid grid-cols-3 pt-3">
